...
class Window(QMainWindow):
    ...
    def Get_CW_Arc_Para(self,CMD, X_old, Y_old):
        ...
        return [rect_X_c, rect_Y_c, rect_H, rect_W, a_old, a_new, x, y]
    ...
    def button1_click(self):
        ...
        if fname[0]!="":
            ...
            for CMD in CMD_LIST:
                ...
                if (Code_Type == "L_LINE"):
                    ...
                    if(a2 <= 0):
                        ...
                        temp1 = X + H*(1+round(decimal.Decimal(math.cos(a)),4))/2
                        temp2 = X + H*(1+round(decimal.Decimal(math.cos(a2)),4))/2
                        X_max = max(X_max, max(temp1,temp2))
                    ...
                    if(a >= 180 and a2 <= 180):
                        ...
                        temp1 = X + H*(1+round(decimal.Decimal(math.cos(a)),4))/2
                        temp2 = X + H*(1+round(decimal.Decimal(math.cos(a2)),4))/2
                        X_min = min(X_min , min(temp1,temp2))

                    if(a >= 90 and a2 <= 90):
                        Y_min = min(Y_min,Y)
                    else:
                        temp1 = Y + H*(1+math.sin(a))/2
                        temp2 = Y + H*(1+math.sin(a2))/2
                        Y_min = min(Y_min , min(temp1,temp2))
                    ...
                    if(a >= 270 and a2 <= 270):
                        ...
                        temp1 = Y + H*(1+math.sin(a))/2
                        temp2 = Y + H*(1+math.sin(a2))/2
                        Y_max = max(Y_max , max(temp1,temp2))
                    DATA.append([2 , X , Y , H , W , a , Sa])
                    ...
                    if(a2 <= 0):
                        ...
                        temp1 = X + H*(1+math.cos(a))/2
                        temp2 = X + H*(1+math.cos(a2))/2
                        X_max = max(X_max, max(temp1,temp2))
            ...
            #factor
            Rect_drawing = QRect(X_min, Y_min, X_max - X_min, Y_max - Y_min)
            ...
            #TRANSLATE
            rect_after_factor=QRect(X_min*factor, Y_min*factor,( X_max - X_min)*factor, (Y_max - Y_min)*factor)
            qp.translate(rect_after_factor.center())
            qp.translate(rect.center()-rect_after_factor.center()*2)
            ...
            for LINE in DATA:
                if (LINE[0] == 1):
                    ...
                    qp.drawArc(LINE[1] * factor, -LINE[2] * factor, LINE[3] * factor, LINE[4] * factor, LINE[5],
                               -LINE[6])
                elif (LINE(0) == 3):
                    qp.drawArc(LINE[1] * factor, -LINE[2] * factor, LINE[3] * factor, LINE[4] * factor, LINE[5],
                               LINE[6])
